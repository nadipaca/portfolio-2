...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative scroll-mt-24">
      <div
        className="relative min-h-[45vh] diagonal-gradient overflow-hidden pt-24 pb-14 sm:pt-28 sm:pb-16"
        onMouseMove={(e) => {
      ...
      >
        <div
          ...
          style={{
            background: `radial-gradient(20vh circle at ${spot.x}px ${spot.y}px, rgba(127,124,122,0.15), transparent 55%),
                         radial-gradient(20vh circle at 20% 30%, rgba(244,63,94,0.04), transparent 20%),
            ...
            >
              <span style={{
                fontFamily:
                  'system-ui, -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial, "Apple Color Emoji", "Segoe UI Emoji"',
                fontWeight: '800',
                color: 'rgba(246, 220, 198, 0.81)'
              }}>Software Engineer</span> building real-time cloud-native products.
            </motion.h1>
      ...
      {/* Tech stack banner */}
      <div className="chip-strip border-t border-white/5 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {['ReactJS', 'NodeJS', 'Spring Boot', 'Fast API', 'React Native', 'AWS'].map((chip) => (
              <span key={chip} className="px-4 py-2 text-base md:text-lg text-slate-500 font-bold text-1xl">
                {chip}
              </span>
            ))}
          </div>
