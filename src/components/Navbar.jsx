...
export default function Navbar({ onOpenChat }) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-xl shadow-lg border-b border-white/10 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <a href="#" className="text-white font-extrabold text-xl tracking-tight">
              <span className="bg-gradient-to-r from-white via-blue-200 to-teal-200 bg-clip-text text-transparent">CN</span>
            </a>
          </div>
